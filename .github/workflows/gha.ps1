...
$proceso = Start-Process `
    ...
    -RedirectStandardOutput "informe.txt" `
    -RedirectStandardError "resultado.txt" `
    -NoNewWindow `
    -Wait `
    -PassThru

$resultado = Get-Content "resultado.txt"
$informe = Get-Content "informe.txt"
...
$lineaSobrecargar = $informe | Where-Object { $_ -match 'sobrecargar\\sobrecargar\.py' }
...
echo ("::notice::Cobertura sobrecargar.py".PadRight(50) + ": $porcentaje%")
